...
Response.Write "<tr>"
Response.Write "<td width=35><a href=/domain.asp target=nohide>"
Response.Write "<img src=/Image/menuTree.jpg width=35 height=20 border=0>"
Response.Write "</a></td>"

'Response.Write Session("Status")
if Session("Status") = "Owner" or Session("Status") = "Admin" then
...
elseif Session("Status") = "Guest" then
	Session(strUpload & "IsAdmin") = false
	Session(strUpload & "IsUser") = true
	...
	Session(strUpload & "IsAdmin") = false
	Session(strUpload & "IsUser") = false
